...
export const colors: { [colorMode: string]: { [color: string]: string } } = {
  light: {
    ...
    '--color-primary-300': '107 221 191',
    '--color-primary-400': '56 184 154',
    '--color-primary-500': '36 168 140',
    '--color-primary-600': '26 135 113',
    '--color-primary-700': '25 108 93',
    '--color-primary-800': '24 87 76',
    '--color-primary-900': '25 72 64',
    '--color-primary-950': '8 43 38',
